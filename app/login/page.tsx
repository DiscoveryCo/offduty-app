    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white border border-[#E5E7EB] rounded-2xl p-10 flex flex-col items-center gap-8 w-full max-w-sm shadow-sm">
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 border border-[#E5E7EB] bg-white text-[#161616] font-medium rounded-lg px-4 py-3 hover:bg-gray-50 transition-colors text-sm"
          >
